...
def generate_anomalous_event(base_time: datetime, user: str = "user001") -> Dict[str, Any]:
    ...
    # Anomalous patterns theo ML_DEVELOPMENT_PLAN.md
    ...
    if anomaly_type == "bulk_copy_usb":
        ...
        # Paste to ChatGPT - Demo scenario từ ML_DEVELOPMENT_PLAN.md
...
def generate_synthetic_dataset(
    ...
    Theo ML_DEVELOPMENT_PLAN.md: 10,000 normal + 50 anomalous
